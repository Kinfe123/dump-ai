...
const CTA = () => {
  return (
    <div>
      <div className="hidden  h-[2px] animate-glow md:block  bg-gradient-to-r from-zinc-300/0 via-zinc-300/50 to-zinc-300/0" />
      ...
      <div className="max-w-7xl mt-20">
        <p className="text-center text-3xl font-display2  bg-gradient-to-tr from-zinc-400/50 via-white to-white/60 bg-clip-text text-transparent">
          ...
          which makes it to be traind and gives you a sharp and concise answer
          about everythig about your website
        </p>
      </div>
      ...
      <div className="hidden mt-10  h-[2px] animate-glow md:block  bg-gradient-to-r from-zinc-300/0 via-zinc-300/50 to-zinc-300/0" />
    </div>
  );
};
export default CTA;
